      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="text-2xl font-bold text-primary mb-4">ARTISAN</div>
            <p className="text-muted-foreground mb-6 max-w-md text-pretty">
              Crafting exceptional digital experiences that inspire, engage, and
              deliver results. Your vision, our expertise, endless
              possibilities.
            </p>
        ...
        <div className="border-t border-border mt-12 pt-8 text-center text-muted-foreground">
          <p>
            &copy; 2025 Artisan. All rights reserved. Crafted with passion and
            precision.
          </p>
        </div>
      </div>
